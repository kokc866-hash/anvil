...
const builderDocs = { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) && "App Builder skill documentation is not distributed with Anvil" };

test("SKILL.md and AGENTS.md name the marker path and bound this script uses", builderDocs, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", builderDocs, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", builderDocs, () => {
