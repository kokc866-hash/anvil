...
1. **Installer:** [Releases](https://github.com/kokc866-hash/anvil/releases) Setup oder ZIP. Oder Zip + Node.js LTS nach `I:\Anvil` (oder wo du willst) entpacken, **start.bat**.
