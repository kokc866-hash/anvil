...
[GitHub Releases](https://github.com/kokc866-hash/anvil/releases): **Setup** oder **ZIP** (Ordner wählen, z. B. `I:\Anvil`, `Anvil.exe` starten). Kein Node.js. Wenn Setup `WinShell.dll` / Temp meldet: auf C: Platz schaffen oder ZIP nutzen.
